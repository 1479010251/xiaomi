	...
	return {
		...
		event: function() {
			...
			this.$loginBtn.onclick = function() {
					...
					sendAjax('http://localhost:7865/disangeyue/xiaomisupe/xiaomisuper/php/register.php', params);
				},
				// 判断用户名称是否存在
				this.$usernameInp.addEventListener('change', function() {
					...
					sendAjax('http://localhost:7865/disangeyue/xiaomisupe/xiaomisuper/php/check_username.php', params);
				}, false);
		},
